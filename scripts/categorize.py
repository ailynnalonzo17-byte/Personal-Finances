...
RULES = [
    ...
    (r"PACIFIC GAS & ELECTRIC|PG&E", "PGE", "Monthly Bills", "H",
     "California utility - inactive since the move to Henderson, NV in August 2026"),
    (r"THE HARTFORD", "Car insurance", "Monthly Bills", "H",
     "Confirmed by you: Hartford is the new car insurance provider (switched from CSAA)"),
    (r"GOOGLE \*HARNA|THEHARNAFIT", "Harna fit", "Monthly Bills", "H", ""),
    (r"PLANET FITNESS", "Planet Fitness", "Monthly Bills", "H",
     "Confirmed by you: membership already canceled - last charge 2026-07-17"),
    (r"GOOGLE \*Life360|LIFE360", "Life 360", "Monthly Bills", "H", ""),
    (r"NV\s*ENERGY|NEVADA POWER", "NV Energy", "Monthly Bills", "H",
     "Henderson, NV electric utility - replaces PGE after the August 2026 move"),
    (r"SOUTHWEST GAS|SW\s*GAS|SWGAS", "SW Gas", "Monthly Bills", "H",
     "Henderson, NV gas utility - new since the August 2026 move"),
    ...
    (r"WESTLAKESVCS", "Auto Loan - Miata", "Debt", "H", "Confirmed by you: Westlake Financial loan payment for the Mazda Miata"),
    (r"^WF\s+PAYMENT", "Auto Loan - Miata", "Debt", "H", "Confirmed by you: Westlake Financial loan payment for the Mazda Miata (servicer name changed from 'WF' to Westlake over time)"),
    ...
    (r"BARCLAYCARD", "CC - Frontier card", "Debt", "H", "Confirmed by your Frontier Airlines World Mastercard statements: Barclays is the issuer"),
    ...
    (r"PAYMENT TO CHASE CARD", "CC - Chase Amazon Visa", "Debt", "H", "Confirmed from the card's own statement: Chase card ending 1755 is your Amazon Prime Visa"),
    ...
    (r"AMAZON MARKETPLA|AMAZON MKTPL|AMAZON\.COM SERVI|AMAZON\.COM\*|AMAZON PRIME\*", "Shop - Amazon", "Expenses", "H", ""),
    ...
    (r"COSTCO WHSE|WWW COSTCO COM", "Groceries - Costco", "Expenses", "H", ""),
    (r"SAFEWAY", "Groceries - Safeway", "Expenses", "H", ""),
    (r"STEVE'S FILIPINO", "Groceries - Steves", "Expenses", "H", ""),
    (r"WM SUPERCENTER|WAL-MART|WALMART\.COM", "Groceries - Walmart", "Expenses", "H", ""),
    ...
    (r"NAPA STORE|O'REILLY|U-HAUL|SAFELITE", "For Car", "Expenses", "H", ""),
    ...
    (r"(RESTAUR|CAFE|BURGER|GRILL|BBQ|PIZZA|TACO|NOODLE|THAI|CHICKEN|SUSHI|BAKERY|COFFEE|DONUT|BOBA|TEA SOCI|DINER|KITCHEN|BUFFET|DELIGHT|CREPES|WINGSTOP|SUBWAY|MCDONALD|WENDY|ARBY|KFC|JOLLIBEE|IN-N-OUT|CARLS JR|FRESH JERKY|FOSTERS FREEZE|STEAK N SHAKE|IHOP|PANERA|STARBUCKS|CHOCOLATE WORL|FAMOUS NYNY|HABIT (SALINAS|BURGER)|TAQUERIA|LITTLE CAESARS|ELPOLLOLOCO|JACK IN THE BOX|OLIVE GARDEN|CHIPOTLE|FREDDY'S|CRAB BUCKET|MAHARLIKA|PAN ASIAN EXPRESS|GHIRARDELLI|SALINAS MAIN IN|COCA COLA|ABC #101|DIM SUM INN|PANDA EXPRESS|AUNTIE ANNE|GOLDILOCKS|CHIBOG|COSMOPOL)", "Food - Eat Out", "Expenses", "D", "Restaurant/fast-food - defaulted to Eat Out; move to Food - Ailynn/Chris/Misc if you know whose order it was"),
    (r"^SQ \*|^TST\*|^SG\*V\*|^CKE\*|^ABC\*P|HOTEL LV|GOLDEN NUGGET", "Food - Eat Out", "Expenses", "D", ""),
    (r"\bIKEA\b.*RESTAUR", "Food - Eat Out", "Expenses", "D", ""),
    (r"TARGET T-|T\.J\. MAXX|TOMMY HILFIGER|MARSHALLS|UNIQLO|KIPLING|LACOSTE|\bCROCS\b|EBAY COMMERCE|GROUPON|REI #|CHIC AND COZY|LA SALON AND SPA|SALINAS LIQUIDATIONS|DOLLAR TREE|NESPRESSO|SUDZ LLC|SHOPPAWVIA|AMBERCUP|SHAPERMINT|OLD NAVY|MARC JACOBS|DAISO", "Shop - Others", "Expenses", "D", ""),
